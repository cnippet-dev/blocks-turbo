...
// This function has been moved to /lib/get-user.ts for global usage
// Use getCurrentUser() from /lib/get-user.ts instead
// export { getCurrentUser as getCurrentUserProfile } from "@/lib/get-user";
