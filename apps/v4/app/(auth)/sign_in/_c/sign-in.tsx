...
import { fadeUpBlur, fadeUp, zoomIn } from "cnippet-aos";
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden">
            ...
            >
                ...
                <div
                    className="absolute bottom-20 left-0 -z-10 h-px w-full flex-auto overflow-hidden border-t border-dashed border-gray-200 dark:border-neutral-700"
                    data-border="true"
