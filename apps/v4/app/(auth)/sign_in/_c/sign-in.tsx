...
import { DashedBorderAll } from "@/components/dashed-layout"
...
export default function SignInForm() {
  ...
  return (
    <section className="font-kantumruy relative h-screen w-full overflow-hidden">
      {/* <motion.div
      ...
      >
        ...
        >
          <div
            className="absolute right-0 bottom-0 z-0 h-full w-px border-r border-dashed border-gray-200 dark:border-neutral-700"
            data-border="true"
          ...
          <div
            className="absolute bottom-0 left-0 z-0 h-full w-px border-r border-dashed border-gray-200 dark:border-neutral-700"
            data-border="true"
        ...
        <div
          className="absolute bottom-10 left-0 -z-10 h-px w-full flex-auto overflow-hidden border-t border-dashed border-gray-200 dark:border-neutral-700"
          data-border="true"
