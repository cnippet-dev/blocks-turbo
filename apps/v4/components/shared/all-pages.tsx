...
interface PagesProps extends React.HTMLAttributes<HTMLDivElement> {
    count?: number;
    ...
    ({ count, pages }, ref) => {
        const components =
            ...
            Object.values(Index).filter(
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                (item: any): item is Page => item.type === "registry:page",
            );
                    ...
                    <div className="mx-auto max-w-7xl px-5">
                        <div className="max-w-7xl px-10">
                            <div className="mb-16 space-y-4">
                                ...
                                >
                                    A collection of professionally designed,
                                    expertly crafted page templates you can drop
                                    into your Tailwind projects and customize to
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1">
                                                        <CldImageComponent
                                                            width={960}
                                                            height={600}
                                                            src={`https://res.cloudinary.com/dcxm3ccir/image/upload/v1753941711/${page.name}.png`}
                                                            sizes="100vw"
                                                        ...
                                                        <div className="flex flex-col items-start p-4">
                                                            ...
                                                            <div className="mt-1 flex items-center gap-2">
                                                                {page.auth && (
                                                                    <motion.span
                                                                        className="rounded border border-gray-300 px-2 py-0.5 text-xs text-gray-400"
                                                                        initial={{
                                                                            opacity: 0,
                                                                            x: -10,
                                                                        }}
