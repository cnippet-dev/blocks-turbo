...
export const mdxComponents = {
  ...
  code: ({
    ...
    if (typeof props.children === "string") {
      return (
        <code
          className={cn(
            "bg-muted warp-break-words relative rounded-md px-[0.3rem] py-[0.2rem] font-mono text-[0.8rem] outline-none",
            className
          )}
          {...props}
        />
  ...
  TabsList: ({
    ...
    <TabsList
      className={cn(
        "inline-flex h-8 items-center rounded-md p-1 *:data-[slot=tabs-trigger]:h-6 *:data-[slot=tabs-trigger]:rounded-sm *:data-[slot=tabs-trigger]:px-2 *:data-[slot=tabs-trigger]:text-xs",
        className
      )}
      {...props}
    />
