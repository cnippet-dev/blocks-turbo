                ...
                <div className="mx-auto grid max-w-7xl grid-cols-12">
                    ...
                    <div className="relative col-span-9 px-16">
                        <Carousel options={{ loop: true }} isAutoPlay={false}>
                            ...
                            <div className="absolute top-0 left-12 h-full w-20 bg-gradient-to-r from-white" />
                            <div className="absolute top-0 right-12 h-full w-20 bg-gradient-to-l from-white" />
