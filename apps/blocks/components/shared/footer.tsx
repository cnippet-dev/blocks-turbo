...
export default function Component() {
    ...
    const onSubmit = async (values: NewsletterFormData) => {
        ...
        try {
            const result = await Newsletter({ email: values.email });
    ...
    return (
        <div className="relative">
            ...
            <section className="p-4">
                <div className="rounded-3xl bg-gray-50 px-4 py-28 md:px-0 dark:bg-black">
                    <div className="dark:bg-background mx-auto max-w-6xl rounded-4xl bg-white px-4 py-2 shadow-lg md:px-10">
                    ...
                    <footer className="">
                        <div className="mx-auto max-w-6xl px-4 pt-16">
                            <div className="grid gap-20 md:grid-cols-2 lg:grid-cols-6">
                                <div className="col-span-2 space-y-2">
                                    ...
                                    <p className="w-[70%] text-sm leading-relaxed text-gray-700 dark:text-gray-400">
                                        Complete ecosystem for modern web
                                        development. Components, blocks,
                                        templates, and comprehensive guides.
                                    </p>
                                </div>
                                                        ...
                                                        <FormControl>
                                                            <div className="dark:bg-background flex overflow-hidden rounded-full bg-white p-1 shadow-sm">
                                                                ...
                                                                <Button
                                                                    ...
                                                                    //     !field.value
                                                                    // }
                                                                    className="cursor-pointer rounded-full bg-blue-700/90 px-6 py-5 text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-white dark:text-black"
                                                                >
                                                                    {form
                                                                        .formState
                                                                        .isSubmitting ? (
                            ...
                            <div className="mt-16 flex flex-col space-y-4 border-t border-gray-200 pt-8 md:flex-row md:items-center md:justify-between md:space-y-0 dark:border-neutral-700">
                                ...
                                <div className="mr-5 ml-0 flex items-end md:ml-auto">
                                    {mounted && (
